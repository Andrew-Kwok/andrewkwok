...
<template>
  <div ref="lottieWrapper" class="absolute bottom-16">
    <div class="text-center" v-if="props.isHome">
      ...
      <p class="text-2xl"> ... or check my <a href="https://drive.google.com/file/d/1Ey755z_0UmQICr5OfS-ovD8A3VhBnYY7/view?usp=sharing" class="font-bold underline link hover:text-info">résumé</a> instead </p>
    </div>
