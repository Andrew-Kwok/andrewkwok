...
<template>
  <div class="card w-96 bg-base-100 shadow-xl">
    <div class="card-body">
      ...
      <p> ... or check my <a href="https://drive.google.com/file/d/1Ey755z_0UmQICr5OfS-ovD8A3VhBnYY7/view?usp=sharing" class="font-bold underline link">résumé</a> instead </p>
    </div>
  </div>
</template>
